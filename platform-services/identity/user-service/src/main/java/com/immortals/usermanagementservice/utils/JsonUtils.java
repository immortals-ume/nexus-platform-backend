...
public final class JsonUtils {
    ...
    public static String toJson(Object obj) {
        try {
            ...
            throw new UserException("JSON serialization failed: " + e.getMessage(), e);
        }
    }
    ...
    public static <T> T fromJson(String json, Class<T> clazz) {
        try {
            ...
            throw new UserException("JSON deserialization failed for class " + clazz.getSimpleName() + ": " + e.getMessage(), e);
        }
    }
    ...
    public static <T> T fromJson(String json, TypeReference<T> typeRef) {
        try {
            ...
            throw new UserException("JSON deserialization failed for type " + typeRef.getType() + ": " + e.getMessage(), e);
        }
    }
}
