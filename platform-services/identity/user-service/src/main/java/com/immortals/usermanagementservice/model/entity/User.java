...
public class User extends BaseEntity implements Serializable {
    ...
    // Keep existing user_id for backward compatibility
    ...
    // Use domain-starter enum for user type
    ...
    // Override the ID generation to maintain backward compatibility
    @PrePersist
    public void generateUserId() {
        if (this.userId == null) {
            // Use the BaseEntity id as userId for new entities
