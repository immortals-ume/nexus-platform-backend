package com.immortals.platform.product.config.db;
...
@EnableJpaRepositories(
        basePackages = "com.immortals.platform.product.repository",
        entityManagerFactoryRef = "entityManagerFactory",
        transactionManagerRef = "transactionManager"
)
@EntityScan(basePackages = "com.immortals.platform.domain.entity")
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emf.setPackagesToScan("com.immortals.platform.domain.entity");
