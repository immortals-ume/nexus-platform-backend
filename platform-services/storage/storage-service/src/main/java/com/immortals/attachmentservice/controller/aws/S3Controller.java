...
public class S3Controller {
    ...
    public S3Controller(AttachmentService service) {
        attachmentService = (s3Service) service;
    }
    ...
    @PostMapping(value = "/upload/multipart", consumes = {MediaType.MULTIPART_FORM_DATA_VALUE, MediaType.APPLICATION_JSON_VALUE}, produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseStatus(HttpStatus.CREATED)
    public String uploadAsMultipartFile(@RequestPart MultipartFile multipartFile, @RequestPart FilePayload filePayload) {
