...
import com.immortals.notification.service.service.TemplateService;
...
public class ThymeleafTemplateService implements TemplateService {
    ...
    public String renderTemplate(String templateCode, Map<String, Object> variables) {
        ...
        try {
            ...
            String result = templateEngine.process(templateCode, context);
            
            // Record metrics
            long duration = System.currentTimeMillis() - startTime;
            metricsService.recordTemplateRenderTime(templateCode, "THYMELEAF", duration);
