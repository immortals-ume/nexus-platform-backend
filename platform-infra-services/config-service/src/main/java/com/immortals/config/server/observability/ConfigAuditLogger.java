...
public class ConfigAuditLogger {
    ...
    public void logConfigAccess(String application, String profile, String label, String clientIp) {
        logConfigAccess(application, profile, label, clientIp, null);
    }
    
    /**
     * Log configuration access for audit purposes with user identity
     */
    public void logConfigAccess(String application, String profile, String label, String clientIp, String user) {
