package com.immortals.config.server.exception;

import com.immortals.config.server.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleEncryptionException(
        ...
        log.error("Encryption error on request to {} with correlation ID {}: {}",
            request.getRequestURI(), getCorrelationId(request), ex.getMessage(), ex);
