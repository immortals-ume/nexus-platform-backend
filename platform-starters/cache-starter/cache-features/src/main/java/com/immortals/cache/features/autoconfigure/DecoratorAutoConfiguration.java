...
public class DecoratorAutoConfiguration {
    ...
    public RedissonClient redissonClient(CacheProperties cacheProperties) {
        ...
        if (!redisConfig.getCluster()
            ...
            config.useClusterServers()
                    .addNodeAddress(redisConfig.getCluster()
                            .getNodes()
                            .stream()
                            .map(node -> "redis://" + node)
                            .toArray(String[]::new));
            ...
            config.useSentinelServers()
                    .setMasterName(redisConfig.getSentinel()
                            .getMaster())
                    .addSentinelAddress(redisConfig.getSentinel()
                            .getNodes()
                            .stream()
                            .map(node -> "redis://" + node)
                            .toArray(String[]::new));
            ...
            if (redisConfig.getAcl() != null && redisConfig.getAcl()
                    .getEnabled() != null && redisConfig.getAcl()
                    .getEnabled() && redisConfig.getAcl()
                    .getUsername() != null) {
                config.useSingleServer()
                        .setUsername(redisConfig.getAcl()
                                .getUsername());
            }
    ...
    public EncryptionConfigurationValidator encryptionConfigurationValidator(
        ...
        String encryptionKey = cacheProperties.getFeatures()
                .getEncryption()
                .getKey();

        if (encryptionKey == null || encryptionKey.trim()
                .isEmpty()) {
    ...
    public DecoratorConfigurationSummary decoratorConfigurationSummary(
        ...
        log.info("Stampede Protection: {} (lock timeout: {})",
                ...
                cacheProperties.getResilience()
                        ...
                        .getLockTimeout());
        log.info("Metrics: {}",
                cacheProperties.getObservability()
                        .getMetrics()
                        .isEnabled());
        log.info("Tracing: {}",
                cacheProperties.getObservability()
    ...
    public DefaultUnifiedCacheManager.DecoratorChainBuilder decoratorChainBuilder(
        ...
        int compressionThreshold = cacheProperties.getFeatures()
                .getCompression()
                .isEnabled()
                ? cacheProperties.getFeatures()
                .getCompression()
        ...
        Duration stampedeTimeout = cacheProperties.getResilience()
                .getStampedeProtection()
                .isEnabled()
                ? cacheProperties.getResilience()
                .getStampedeProtection()
        ...
        boolean circuitBreakerEnabled = cacheProperties.getResilience()
                .getCircuitBreaker()
                .isEnabled();
