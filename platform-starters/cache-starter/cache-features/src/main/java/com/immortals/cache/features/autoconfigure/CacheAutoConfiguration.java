...
public class CacheAutoConfiguration {
    ...
    private CacheConfiguration createDefaultConfiguration(CacheProperties properties) {
        ...
        config.setCompressionEnabled(properties.getFeatures().getCompression().isEnabled());
        config.setEncryptionEnabled(properties.getFeatures().getEncryption().isEnabled());
        config.setStampedeProtectionEnabled(properties.getResilience().getStampedeProtection().isEnabled());
        config.setCircuitBreakerEnabled(properties.getResilience().getCircuitBreaker().isEnabled());
