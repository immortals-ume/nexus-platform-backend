...
package com.immortals.platform.cache.providers.multilevel;
...
import com.immortals.platform.cache.providers.redis.RedisCacheService;
import com.immortals.platform.cache.providers.redis.RedisProperties;
import com.immortals.platform.cache.providers.resilience.DecoratorChainFactory;
 ...
 * </ul>
 * 
 * <p>This is imported by MultiLevelAutoConfiguration in the features package.
 * 
 * @since 2.0.0
 */
@Configuration
