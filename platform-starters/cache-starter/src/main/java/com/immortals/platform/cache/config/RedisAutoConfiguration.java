...
import com.immortals.platform.cache.config.CachePropertiesMapper;
import com.immortals.platform.cache.config.RedisDeploymentMode;
import com.immortals.platform.cache.providers.redis.CacheClusterConfiguration;
import com.immortals.platform.cache.providers.redis.CacheSentinelConfiguration;
import com.immortals.platform.cache.providers.redis.CacheStandaloneConfiguration;
    ...
    public RedisProperties redisProperties(CacheProperties cacheProperties) {
        ...
        try {
            ...
            log.info("Redis properties configured: host={}, port={}, database={}, useSsl={}, deploymentMode={}",
                    properties.getHost(), properties.getPort(), properties.getDatabase(), properties.getUseSsl(), deploymentMode);
