...
public class CacheStandaloneConfiguration {
     ...
     */
    @Bean
    public com.immortals.platform.cache.core.CacheService<String, Object> redisCacheService(
        ...
        try {
            ...
            com.immortals.platform.cache.core.CacheService<String, Object> decorated = decoratorFactory.buildDecoratorChain(
                    baseCache,
                    "default",
                    enableMetrics,
