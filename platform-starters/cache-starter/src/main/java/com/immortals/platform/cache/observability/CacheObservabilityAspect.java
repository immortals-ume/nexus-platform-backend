...
public class CacheObservabilityAspect {
     ...
     */
    @Pointcut("execution(* com.immortals.platform.cache.core.CacheService.get(..))")
    public void getCacheOperation() {}

    /**
     * Pointcut for all CacheService.put() methods.
     */
    @Pointcut("execution(* com.immortals.platform.cache.core.CacheService.put(..))")
    public void putCacheOperation() {}

    /**
     * Pointcut for all CacheService.remove() methods.
     */
    @Pointcut("execution(* com.immortals.platform.cache.core.CacheService.remove(..))")
    public void removeCacheOperation() {}

    /**
     * Pointcut for all CacheService.getAll() methods.
     */
    @Pointcut("execution(* com.immortals.platform.cache.core.CacheService.getAll(..))")
    public void getAllCacheOperation() {}

    /**
     * Pointcut for all CacheService.putAll() methods.
     */
    @Pointcut("execution(* com.immortals.platform.cache.core.CacheService.putAll(..))")
    public void putAllCacheOperation() {}

    /**
     * Pointcut for all CacheService.clear() methods.
     */
    @Pointcut("execution(* com.immortals.platform.cache.core.CacheService.clear(..))")
