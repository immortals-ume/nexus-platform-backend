package com.immortals.platform.domain.user;
...
public class UserAddress extends BaseEntity {
    ...
    private com.immortals.platform.domain.entity.Country country;

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "state_id", nullable = false)
    private com.immortals.platform.domain.entity.States states;

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "city_id", nullable = false)
    private com.immortals.platform.domain.entity.City city;
}
